...
function useCompoundParent() {
  ...
  const registerItem = React56.useCallback(function registerItem2(id, item, missingKeyGenerator) {
...
function useCompoundItem(id, itemMetadata, missingKeyGenerator) {
  ...
  const [registeredId, setRegisteredId] = React60.useState(id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
function useSelect(props) {
  ...
  const ignoreEnterKeyUp = React66.useRef(false);
  const ignoreClick = React66.useRef(false);
  const [listboxFocusRequested, requestListboxFocus] = React66.useState(false);
  const focusListboxIfRequested = React66.useCallback(() => {
  ...
  const handleStateChange = React66.useCallback((e, field, fieldValue) => {
    if (field === "open") {
      onOpenChange == null ? void 0 : onOpenChange(fieldValue);
...
var init_Select = __esm({
  "node_modules/@mui/base/Select/Select.js"() {
    ...
    _excluded30 = ["autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "onChange", "onListboxOpenChange", "optionStringifier", "renderValue", "slotProps", "slots", "value"];
...
var React79, import_prop_types40, import_jsx_runtime50, _excluded37, useUtilityClasses18, TabPanel;
...
var React82, import_prop_types41, import_jsx_runtime52, _excluded38, useUtilityClasses19, TabsList;
...
var React84, import_prop_types42, import_jsx_runtime53, _excluded39, useUtilityClasses20, Tab;
var init_Tab = __esm({
  "node_modules/@mui/base/Tab/Tab.js"() {
    init_extends();
    init_objectWithoutPropertiesLoose();
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AK7XYWRC.js.map
